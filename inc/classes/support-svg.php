...
if ( ! class_exists( 'AfftraBlocks_SupportSVG' ) ) {

	class AfftraBlocks_SupportSVG {
		...
		public function __construct() {
			add_filter( 'wp_check_filetype_and_ext', array( $this, 'sanitize_svg_uploads' ), 10, 4 );
			add_filter( 'upload_mimes', array( $this, 'modify_svg_mimes' ) );
			add_action( 'init', array( $this, 'add_flush_rewrite_rules' ) );
			add_filter( 'user_has_cap', array( $this, 'filter_user_capabilities' ), 10, 3 );
			add_action( 'admin_head', array( $this, 'add_svg_support_style' ) );
		}
...
new AfftraBlocks_SupportSVG();    // Initialize the class.